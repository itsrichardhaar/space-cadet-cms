...
class TemplatesController {
    ...
    public function create(Request $req): void { Auth::requireRole('developer'); $d=Validator::validate($req->json()??[],['name'=>'required|string','slug'=>'required|slug|unique:templates.slug'])->failOrReturn(); $id=Template::create($d); Response::created(Template::findById($id)); }
